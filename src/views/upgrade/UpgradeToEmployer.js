...
function upgrade(setSuccess, setLoading, setError, info, identities) {
    setLoading(true)
    axios({
        method: "POST",
...
const UpgradeToEmployerView = ({ authState }) => {
                ...
                <Container maxWidth="sm">
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                            ...
                            upgrade(setUpgradeSuccess, setLoading, setError, info, identities)
                        }}
                    >
                        {({
                            errors,
